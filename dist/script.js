...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup_engineer', '.popup_engineer_btn', modalTimer);
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup', '.phone_link', modalTimer);
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup_calc', '.glazing_price_btn', modalTimer);
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup_calc_profile', '.popup_calc_button', modalTimer, false);
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup_calc_end', '.popup_calc_profile_button', modalTimer, false);
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('2022-06-25');
});
...
function openModal(modalSelector, openSelector, modalTimer) {
  var closeClickOverlay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  var modal = document.querySelector(modalSelector);
  var btn = document.querySelectorAll(openSelector); // const windows = document.querySelectorAll('[data-modal]');
  ...
  btn.forEach(function (item) {
    item.addEventListener('click', function (e) {
      ...
      if (item.getAttribute('data-check') === 'true') {
        ...
        if (check) {
          document.querySelectorAll('.checkbox-custom').forEach(function (item) {
  ...
  modal.addEventListener('click', function (e) {
    if (e.target.getAttribute('data-close') || e.target.classList.contains(modalSelector.replace(/\./, '')) && closeClickOverlay) {
      modal.style.display = 'none';
      document.body.style.overflow = 'auto'; // windows.forEach(item => {
...
function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  function hideTabContent() {
    content.forEach(function (item, i) {
      item.style.display = 'none';
      content[i].classList.add('animate__animated', 'animate__slideInUp');
    });
...
function timer(deadline) {
  ...
  function timeLeft(deadline) {
    var dateLeft = new Date(deadline) - new Date();
  ...
  seconds.innerHTML = zero(timeLeft(deadline).seconds); // timer(days, hours, minutes, seconds, deadline);

  updateTime.bind(null, days, hours, minutes, seconds, deadline);
  var interval = setInterval(updateTime.bind(null, days, hours, minutes, seconds, deadline), 1000);

  function updateTime(days, hours, minutes, seconds, deadline) {
    var time = timeLeft(deadline);
